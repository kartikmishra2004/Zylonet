...
export const AuthProvider = ({ children }) => {
    ...
    const userAuthentication = async () => {
        try {
            const response = await fetch("https://zylonet-server.onrender.com/api/v1/auth/userauth", {
                method: "GET",
                headers: {
    ...
    const updateProfile = async ({ updatedUser, id }) => {
        try {
            const response = await fetch(`https://zylonet-server.onrender.com/api/v1/auth/update/${id}`, {
                method: "PUT",
                headers: {
    ...
    const handleDeletePost = async (id) => {
        const response = await fetch(`https://zylonet-server.onrender.com/api/v1/post/deletepost/${id}`, {
            method: "DELETE",
            headers: {
                Authorization: `Bearer ${token}`,
            },
    ...
    const handleFollow = async ({ id, setFollowersCount, setFollowingCount }) => {
        try {
            ...
            const response = await fetch("https://zylonet-server.onrender.com/api/v1/follow", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const handleUnfollow = async ({ id, setFollowersCount, setFollowingCount }) => {
        try {
            ...
            const response = await fetch("https://zylonet-server.onrender.com/api/v1/unfollow", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
