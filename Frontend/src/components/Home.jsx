  ...
  return (
    <div className='md:ml-[18rem]'>
      ...
      <div class="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
        <div class="columns-1 md:columns-2 xl:columns-4 gap-7 ">
          {ranPosts.map((item) => (<div
            key={item._id}
            class="border-r rounded-lg border-b border-l border-zinc-300 lg:border-t bg-white break-inside-avoid mb-8 relative flex flex-col justify-between leading-normal">
            <img src={item.image} class="w-full mb-3 rounded-t-lg cursor-pointer"/>
            <div class="p-4 pt-2">
              <div>
                <a href="#" class="text-gray-700 font-bold text-lg mb-2 hover:text-[#00B855] inline-block">{item.title}</a>
                <p class="text-gray-700 text-sm">{item.caption}</p>
              </div>
              <div class="flex items-center w-full text-xs justify-between text-gray-500 py-5 mb-8">
                <div class="flex items-center space-x-2">
                  <button class="flex justify-center items-center gap-2 px-2 hover:bg-gray-50 rounded-full p-1">
                    <svg class="w-5 h-5 fill-current hover:fill-[#ff2f2f]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                <button class="flex justify-center items-center gap-2 px-2 hover:bg-gray-50 rounded-full p-1">
                  <svg width="22px" height="22px" viewBox="0 0 24 24" class="w-5 h-5 fill-current hover:fill-[#00B855]" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="flex items-center">
                <a
                  href="#"><img class="w-10 h-10 rounded-full mr-4" src={item.author.profile} alt="Avatar of Jonathan Reinink" /></a>
                <div class="text-sm">
                  <a href="#" class="text-gray-700 font-semibold leading-none hover:text-[#00B855]">{item.author.username}</a>
                  <p class="text-gray-600">{timeAgo(item.createdAt)}</p>
                </div>
