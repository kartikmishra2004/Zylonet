...
const Navbar = () => {
    return (
        <div className="flex fixed flex-col items-center w-60 h-full overflow-hidden text-gray-700 bg-gray-100 rounded">
            <Link className="flex text-[#00B855] items-center w-full px-3 mt-3" to="/home">
            ...
            <div className="w-full px-2">
                <div className="flex flex-col items-center w-full mt-3 border-t border-gray-300">
                    <Link className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300" to="/home">
