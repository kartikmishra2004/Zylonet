        ...
        <div>
            ...
            <div title='Ask ZyloAI' className='fixed z-50'>
                <button
                    ...
                    className="fixed md:bottom-4 md:right-4 bottom-2 right-2 inline-flex items-center justify-center text-sm font-medium disabled:pointer-events-none disabled:opacity-50 border-2 rounded-full md:w-16 md:h-16 h-12 w-12 bg-[#00B855] hover:bg-[#22a45e] transition-all duration-300 ease-in-out m-0 cursor-pointer bg-none p-0 normal-case leading-5 border-white"
