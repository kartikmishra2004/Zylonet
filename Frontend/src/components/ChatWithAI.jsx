    ...
    return (
        <div>
            <div style={{ boxShadow: "0 0 #0000, 0 0 #0000, 0 1px 2px 0 rgb(0 0 0 / 0.05)" }}
                class={`fixed ${showAI} z-50 bottom-[calc(4rem+1.5rem)] right-0 mr-4 bg-white p-6 rounded-lg border border-gray-400 w-[440px] h-[500px]`}>

                <div class="flex flex-col space-y-1.5 pb-6">
                    <h2 class="font-semibold text-lg tracking-tight">Ask ZyloAI</h2>
                    <p class="text-sm text-[#6b7280] leading-3">Powered by Zylonet</p>
                </div>

                <div class="pr-4 h-[350px]" style={{ minWidth: "100%", display: "table" }}>
                    <div class="flex gap-3 my-4 text-gray-600 text-sm flex-1"><span
                        ...
                        <p class="leading-relaxed"><span class="block font-bold text-gray-700">ZyloAI </span>Hi, how can I help you today?
                        </p>
                    </div>
                    <div class="flex gap-3 my-4 text-gray-600 text-sm flex-1"><span
                        class="relative flex shrink-0 overflow-hidden rounded-full w-8 h-8">
                    ...
                    <div class="flex gap-3 my-4 text-gray-600 text-sm flex-1"><span
                        ...
                        <p class="leading-relaxed"><span class="block font-bold text-gray-700">ZyloAI </span>Sorry, I couldn't find any
                ...
                <div class="flex items-center pt-0">
                    <form class="flex items-center justify-center w-full space-x-2">
                        ...
                        <button
                            class="inline-flex items-center justify-center rounded-md text-sm font-medium text-[#f9fafb] disabled:pointer-events-none disabled:opacity-50 bg-[#00B855] hover:bg-[#22a45e] transition-all duration-200 ease-in-out h-10 px-4 py-2">
                            Send</button>
                    </form>
                </div>
            </div>
