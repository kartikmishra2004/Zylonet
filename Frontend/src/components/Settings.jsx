    ...
    <div className={`md:ml-[15rem] pl-[3rem] h-screen ${!night ? 'bg-[#2a2834] text-[#dadada]' : ''} transition-all duration-500 ease-in-out`}>
      ...
      <div className="container mx-auto p-4">
        <div className="w-full md:py-14">
          ...
          <div class="md:w-[40vw] py-4 flex items-center gap-3">
            <p class="py-2 text-xl font-semibold">Dark mode</p>
            <label class="inline-flex items-center cursor-pointer">
              <input onClick={gandleNightMode} type="checkbox" value="" class="sr-only peer" checked={!night ? "true" : ""}/>
              <div class="relative w-11 h-6 bg-gray-200 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-[#00B855]"></div>
            </label>
          </div>
          <div class="mb-10 md:w-[40vw] pt-4 border-t-2 border-gray-200">
            ...
            <p class="mt-2">No longer want to use our service? You can delete your account here. This action is not reversible. All information related to this account will be deleted permanently.
